...
# CHANNEL SETTINGS
SOURCE_DOMAIN = "http://www.aurosiksha.org/"                 # content provider's domain
SOURCE_ID = "Aurosiksha"                             # an alphanumeric channel ID
CHANNEL_TITLE = "Aurosiksha"       # a humand-readbale title
...
SAMPLE_TREE = {}
SAMPLE_TREE['title'] = "Aurosiksha"
SAMPLE_TREE['id'] = generate_uuid()
SAMPLE_TREE['description'] = "Sample Aurosiksha Channel"
...
for file in os.listdir(content_path):
    ...
    for file1 in os.listdir(path):
        ...
        if os.path.isdir(path2):
            ...
            FINAL_TREE1['children'].append(FINAL_TREE2)

        else:
            FINAL_TREE1['children'].append(conversion_call(file1, path2))


        
    SAMPLE_TREE['children'].append(FINAL_TREE1)
...
print("*******************FINAL BUILD TREE:::::-------------",SAMPLE_TREE1)
